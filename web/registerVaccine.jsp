<%-- 
    ...
    Created on : Dec 5, 2021, 11:01:09 PM
    Author     : USER
--%>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6 mr-auto ml-auto">
                    <center><h3>REGISTER VACCINE</h3></center>
                    <form action="registerVc.jsp" method="post">
                        <label>Type</label><br>
                        <input class="form-control" type="text" name="type" required=""><br>
                        <label>Dozzes</label><br>
                        <input class="form-control" type="text" name="dozzes" required=""><br>
